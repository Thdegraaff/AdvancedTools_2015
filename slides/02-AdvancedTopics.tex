...
treated <- c(5.81, 6.17, 5.41, 6.59, 5.87,
             5.83, 6.03, 4.89, 4.32, 6.69)
group <- gl(2, 10, 20, labels = c("Control", "Treated"))
weight <- c(control, treated)
m1 <- lm(weight ~ group - 1)
m2 <- lm(weight ~ group)

stargazer(m1, m2, out = "./table.tex",
  title = "My experiment", keep.stat=c("rsq","n"),
