...
\usepackage[T1]{fontenc}
\usepackage{pgf, microtype, booktabs, times, etex, minted}
...
\item
  ...
  why they make sense)
\item
  \LaTeX{} is used very much in the scientific world and can \emph{work} together with
  \begin{itemize}
  \item \texttt{Stata}/\texttt{R}
  \item Markdown/HTML
...
\texttt{\section{\texorpdfstring{\LaTeX}{}}\label{section}
...
\documentclass{article}
 % a % indicates line is a comment
 % This area is called preamble
\title{This is brilliant}
\author{Thomas de Graaff}
