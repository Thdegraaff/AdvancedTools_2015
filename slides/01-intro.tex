...
\begin{frame}{OK; and now what?}
	\begin{enumerate}
		\item Save your file in your folder (give is an appropriate name)
		\newline
...
\begin{frame}{Exercise 4: Create these formula's}
	\begin{enumerate} 
...
\begin{frame}[fragile]{Exercise 5: Refer to tables}
...
And refer to it in text as such: Table \ref{tab:grades} gives the average grades for course \textit{solving crimes}.
\end{frame}
